...
class CustomTextFiled extends StatefulWidget {
  ...
  const CustomTextFiled({
    ...
    this.readOnly = false,
    this.keyboardType,
    this.borderColor = ColorConstants.lightBlueColor,
    this.fillColor = ColorConstants.whiteColor,
    this.helperTextColor = ColorConstants.blackColor,
    this.hintsColor = ColorConstants.greyPurpleColor,
    this.borderRadius = 8,
    this.suffixIcon,
    this.prefixIcon,
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          style:Get.textTheme.titleMedium!.copyWith(color:ColorConstants.darkGreyColor,fontWeight: FontWeight.w600,fontSize: 16 ),
          ...
          decoration: InputDecoration(
           errorMaxLines: widget.errorMaxLines,
             ...
             // isDense: true,
              ...
              contentPadding: const EdgeInsets.symmetric(horizontal: 8, vertical: 9.5), // old
